package org.jwklomp.clientreport.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.jwklomp.clientreport.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.jwklomp.clientreport.repository.UserRepository.USERS_BY_EMAIL_CACHE);
