    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="clientreportApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="clientreportApp.location.home.createLabel">Create a new Location</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {locationList && locationList.length > 0 ? (
            <Table responsive aria-describedby="location-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="clientreportApp.location.streetAddress">Street Address</Translate>
                  </th>
                  <th>
                    <Translate contentKey="clientreportApp.location.postalCode">Postal Code</Translate>
                  </th>
                  <th>
                    <Translate contentKey="clientreportApp.location.city">City</Translate>
                  </th>
                  <th>
                    <Translate contentKey="clientreportApp.location.stateProvince">State Province</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="clientreportApp.location.home.notFound">No Locations found</Translate>
            </div>
          )}
        </div>
      </div>
